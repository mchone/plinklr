...
ax = manhattanplot(data, xlabel="Chromosome", ylabel="pi_wr/ind",kind="line",linewidth=0.8)
######adjust y-axe 

#plt.ylim(0,200)
plt.ylim(0,120)
#plt.axhline(y=60,linewidth=0.4 ,color='k', linestyle='dashed')
plt.axhline(y=40,linewidth=0.4 ,color='k', linestyle='dashed')
